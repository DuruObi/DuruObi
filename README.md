...
## 🌍 About Me  
- 🔹 Currently exploring **Github, Next.js, AI tools, and web automation**  
- 🔹 Experienced with **Github, SITE123, Wix, and no-code platforms** — helping businesses get online fast  
- 🔹 Experimenting with **ethical hacking, Dev, firewalls, and Nmap** to understand system security  
- 🔹 Building **content-driven projects** — from **Web Developing, YouTube true crime storytelling** to **TikTok animal stories**  
...
- **Web Builders:** Github, SITE123, Wix, WordPress  
- **Creative Tools:** Microsoft365, Github, BandLab (music), AI Image/Video Generators  
- **Other Interests:** Website developing, Affiliate Marketing, Content Creation, NFT Experiments  
